...
def sample_camera(camera_data_mode, n, device='cuda'):
    ...
    if 'shapenet_car' in camera_data_mode or 'shapenet_chair' in camera_data_mode or 'shapenet_motorbike' in camera_data_mode \
            or 'shapenet_bed' in camera_data_mode or 'shapenet_plane' in camera_data_mode \
            or 'ts_house' in camera_data_mode:
